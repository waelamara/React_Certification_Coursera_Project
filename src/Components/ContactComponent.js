 ...
 */
   ...
   /*  handleBlur =(field) =>(evt) =>{
    ...
    validate(firstname,lastname,telnum,email){
        ...
        errors.lastname="First Name should be >= 3 caracters";
        else if(this.state.touched.lastname && lastname.lenght>10)
        errors.lastname="First Name should be <= 10 caracters";
                ...
                <div className="row row-content">
                    ...
                    <div className="col-12 col-sm-11 offset-sm-1">
                        <div className="btn-group" role="group">
                            ...
                            <a role="button" className="btn btn-info" href="GH"><i className="fa fa-skype"></i> Skype</a>
